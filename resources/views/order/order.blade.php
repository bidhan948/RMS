        ...
        <div class="container-fluid">
            <h6 class="mb-2 p-2">
                <a href="{{ route('order.index') }}" class="btn btn-sm btn-primary"><i
                        class="fa-solid fa-cart-shopping px-1"></i>Current Order</a>
                <a href="{{ route('order.history') }}" class="btn btn-sm btn-success"><i
                        class="fa-solid fa-clock-rotate-left px-1"></i> View Order history</a>
            </h6>
                        ...
                        <template v-for="(order,key) in orders">
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a v-if="!order[0].status" type="button" class="btn btn-danger"
                                        v-on:click="redirectPayment(order[0].token)">
                                        Proceed To Payment <i class="fa-sharp fa-solid fa-money-bill px-1"></i>
                                    </a>
                                    <a v-if="!order[0].status" type="button" class="btn btn-dark"
                                        v-on:click="redirectTransferTable(order[0].token)">
                                        Transfer / Edit Table <i class="fa-solid fa-table px-1"></i>
                                    </a>
                                </td>
                            </tr>
                        </template>
    ...
    <script defer>
        new Vue({
            ...
            methods: {
                ...
                redirectTransferTable: function(params) {
                    let vm = this;
                    window.location.href = "{{ url('/') }}/" + 'order/edit-table/' + params;
                },
            },
            mounted() {
                let vm = this;
